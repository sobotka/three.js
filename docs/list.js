var list = {
	...
	"Examples": {
		...
		"Nodes": {
			"AttributeNode": "examples/nodes/AttributeNode",
			"ConstNode": "examples/nodes/ConstNode",
			"CameraNode": "examples/nodes/accessors/CameraNode",
			"ColorsNode": "examples/nodes/accessors/ColorsNode",
			"LightNode": "examples/nodes/accessors/LightNode",
			"NormalNode": "examples/nodes/accessors/NormalNode",
			"PositionNode": "examples/nodes/accessors/PositionNode",
			"ReflectNode": "examples/nodes/accessors/ReflectNode",
			"ScreenUVNode": "examples/nodes/accessors/ScreenUVNode",
			"UVNode": "examples/nodes/accessors/UVNode",
			"ColorNode": "examples/nodes/inputs/ColorNode",
			"CubeTextureNode": "examples/nodes/inputs/CubeTextureNode",
			"FloatNode": "examples/nodes/inputs/FloatNode",
			"IntNode": "examples/nodes/inputs/IntNode",
			"Matrix3Node": "examples/nodes/inputs/Matrix3Node",
			"Matrix4Node": "examples/nodes/inputs/Matrix4Node",
			"ScreenNode": "examples/nodes/inputs/ScreenNode",
			"TextureNode": "examples/nodes/inputs/TextureNode",
			"Vector2Node": "examples/nodes/inputs/Vector2Node",
			"Vector3Node": "examples/nodes/inputs/Vector3Node",
			"Vector4Node": "examples/nodes/inputs/Vector4Node",
			"Math1Node": "examples/nodes/math/Math1Node",
			"Math2Node": "examples/nodes/math/Math2Node",
			"Math3Node": "examples/nodes/math/Math3Node",
			"OperatorNode": "examples/nodes/math/OperatorNode",
			"PhongNode": "examples/nodes/materials/PhongNode",
			"PhongNodeMaterial": "examples/nodes/materials/PhongNodeMaterial",
			"SpriteNode": "examples/nodes/materials/SpriteNode",
			"SpriteNodeMaterial": "examples/nodes/materials/SpriteNodeMaterial",
			"StandardNode": "examples/nodes/materials/StandardNode",
			"StandardNodeMaterial": "examples/nodes/materials/StandardNodeMaterial",
			"SwitchNode": "examples/nodes/utils/SwitchNode",
			"UVTransformNode": "examples/nodes/utils/UVTransformNode",
		},
